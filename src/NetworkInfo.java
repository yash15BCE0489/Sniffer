...
public class NetworkInfo {
    ...
    private JFrame MainWindow = new JFrame("Yash's Sniffer v1.0");
    private JLabel L_Title = new JLabel("Network Interface Information");
    private JLabel L_TotalInterfaces = new JLabel("Total # Interfaaces on this Host:");
...
//------------------------------------------------------------------------------------------------------------
        ...
        L_PointToPoint.setForeground(new java.awt.Color(255,0,0));
        L_PointToPoint.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        L_PointToPoint.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0,0,0)));
        MainWindow.add(L_PointToPoint);
        L_PointToPoint.setBounds(112,230,248,16);
//------------------------------------------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
    ...
    public void DisplayInterfaceInfo( int INT_NUM)
    {
        try
        {
            ...
            for(InetAddress X : Collections.list(ALL_ADDRESSES))
            {
                ...
                L_HostName_Box.setText(X.getHostAddress());
            }
    ...
    public void Add_Listeners()
    {
        ...
        new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evr)
            { ACTION_B_NEXT();}
        }
        );
    ...
    {
        if(InterfaceNumber < (InterfaceNumber-1))
        {
            InterfaceNumber++;
            DisplayInterfaceInfo(InterfaceNumber);
        }
